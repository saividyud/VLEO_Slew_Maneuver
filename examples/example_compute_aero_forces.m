% Example use of vleo.aero.compute_aero_forces for the 6U CubeSat mesh.
...
cookResults = vleo.aero.compute_aero_forces(objFile, location, attitude, time, cookOptions);
sentmanResults = vleo.aero.compute_aero_forces(objFile, location, attitude, time, sentmanOptions);
