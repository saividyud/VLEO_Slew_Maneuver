...
for i = 1:tlen
    ...
    surf(xtn, ytn, ztn);
    surf(xvn, yvn, zv);
    plot3([BCM(1) In(1)], [BCM(2) In(2)], [BCM(3) In(3)], 'k', 'linewidth', lw);
    plot3([BCM(1) Jn(1)], [BCM(2) Jn(2)], [BCM(3) Jn(3)], 'k', 'linewidth', lw);
    plot3([BCM(1) Kn(1)], [BCM(2) Kn(2)], [BCM(3) Kn(3)], 'k', 'linewidth', lw);
    colormap('jet')
    shading interp
