...
%
%***********************************************************************
function [TEMP,RHO] = JB2006(MJD,r_Sun,r_SAT,E)

global SOLdata APdata
...
[year,month,day,hour,minute,sec] = invjday(MJD-6.7/24);
...
[year,month,day,hr,min,sec] = invjday(MJD);
