...
function openNewSimulation(mainFigHandle)
    ...
    simParams.initParams = struct(); % This will hold all the actual simulation parameters (like time, orbital initParams, etc.) in a nested structure
    ...
    simParams.initParams.Orbit = struct(...
        'altitude', 400e3, ...
        'semiMajorAxis', 400e3 + earthRadius, ... % Convert altitude to semimajor axis [m]
        'eccentricity', 0, ...
        'inclination', 0, ...
        'argPeriapse', 0, ...
        'RAAN', 0, ...
